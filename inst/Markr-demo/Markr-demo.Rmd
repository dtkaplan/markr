...
```{r login-section, echo=FALSE, warning=FALSE,  comment="Ignore this ..."}
user_ID(email = "StatPrep.Annie@gmail.com",  
        key = password_key, store = store_key)
```
